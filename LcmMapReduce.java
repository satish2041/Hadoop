...
public class LcmMapReduce {
  ...
  public static class IntSumReducer
    ...
    private IntWritable result1 = new IntWritable(1);
    ...
    public void reduce(IntWritable key, Iterable<IntWritable> values,
     ...
     int y=result.get();
     int z=val.get();
       result.set(LcmOfNumbers.lcm(y,z));
  ...
  public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(LcmMapReduce.class);
